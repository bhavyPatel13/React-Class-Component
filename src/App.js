  ...
  render() {
    return (
      <div>
        ...
        <Navbar />
          <Routes>
            <Route exact path="/" element={<News pageSize={5} page={1} country="us" category="bussiness" />} />
            <Route exact path="/home" element={<News key="home" pageSize={5} page={1} country="us" category="home" />} />
